  ...
  <div class="alert_content">
    ...
    <div class="neirong" v-if="this.$props.godetail == '1'">
      ...
      <div class="pictures">
        ...
        <div class="pics">
          <img
            v-for="(item, index) in this.detailinfo.pic"
            :key="index"
            :src="item"
            alt=""
          />
    ...
    <div class="neirong" v-if="this.$props.godetail == '3'">
      ...
      <div class="charge_per text1">
        测试专家：{{ this.detailinfo.tester_expert }}
      </div>
    ...
    <div class="neirong" v-if="this.$props.godetail == '4'">
      <div class="single_huifu text1">
