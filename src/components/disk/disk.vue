  ...
  <div class="disk-container">
    ...
    <div class="intro">
      <div class="center">
        ...
        <div class="pieces">
          <div
            class="future_ui__piece autoplay"
            id="autoplay0"
            :class="{ hover: hoverActive == 0 }"
          >
            <span>庄稼医院</span>
            <div class="line"></div>
            <div class="tip"></div>
...
export default {
  ...
  methods: {
    // run() {
    //   timer = setInterval(this.cycle, 2000)
    // },
    // cycle() {
    //   var list = document.getElementsByClassName('autoplay')
    //   for (var j = 0; j < list.length; j++) {
    //     list[j].classList.remove('hover')
    //   }
    //   document.getElementById('autoplay' + i).classList.add('hover')
    //   if (i == 4) {
    //     i = 0
    //   } else {
    //     i++
...
body .center .core {
  ...
  border-radius: 50px;
  background: #0bcbde;
  box-shadow: 0px 0px 70px 20px #0bcbde;
}
...
body .center .outer_one__piece {
  ...
  height: 30px;
  background: #0bcbde;
  box-shadow: 0px 0px 20px 0px #0bcbde;
...
body .center .outer_two__piece {
  ...
  height: 5px;
  background: #ecfcff;
  box-shadow: 0px 0px 20px 0px #ecfcff;
...
body .center .pieces .future_ui__piece {
  border: 3px solid rgb(26 253 251);
  position: absolute;
  font-weight: 900;
  padding: 30px;
  font-size: 30px;
...
//   box-shadow: 0px 0px 55px #85dfe4;
// }
...
//   box-shadow: 0px 0px 55px #85dfe4b0;
// }
...
@-webkit-keyframes wiggle {
  0% {
    -webkit-transform: translateY(0) translateZ(-840px) rotateX(34deg) rotateY(-21deg) rotatez(80deg) scale(0.9);
            transform: translateY(0) translateZ(-840px) rotateX(34deg) rotateY(-21deg) rotatez(80deg) scale(0.9);
  }
  25% {
    -webkit-transform: translateY(0) translateZ(-820px) rotateX(36deg) rotateY(-24deg) rotatez(84deg) scale(0.9);
            transform: translateY(0) translateZ(-820px) rotateX(36deg) rotateY(-24deg) rotatez(84deg) scale(0.9);
  }
  50% {
    -webkit-transform: translateY(0) translateZ(-840px) rotateX(32deg) rotateY(-23deg) rotatez(82deg) scale(0.9);
            transform: translateY(0) translateZ(-840px) rotateX(32deg) rotateY(-23deg) rotatez(82deg) scale(0.9);
  }
  75% {
    -webkit-transform: translateY(0) translateZ(-840px) rotateX(33deg) rotateY(-19deg) rotatez(78deg) scale(0.9);
            transform: translateY(0) translateZ(-840px) rotateX(33deg) rotateY(-19deg) rotatez(78deg) scale(0.9);
  }
  100% {
    -webkit-transform: translateY(0) translateZ(-840px) rotateX(34deg) rotateY(-21deg) rotatez(80deg) scale(0.9);
            transform: translateY(0) translateZ(-840px) rotateX(34deg) rotateY(-21deg) rotatez(80deg) scale(0.9);
...
@keyframes wiggle {
  ...
  100% {
    -webkit-transform: translateY(0) translateZ(-840px) rotateX(36deg) rotateY(-21deg) rotatez(80deg) scale(0.9);
            transform: translateY(0) translateZ(-840px) rotateX(36deg) rotateY(-21deg) rotatez(80deg) scale(0.9);
  }
}
...
body .center .core{background:#d41562;box-shadow: 0px 0px 70px 20px #d41562;}
body .center .outer_one__piece{transform-origin: 72px 0px;left:41px;background:#d41562;box-shadow: 0px 0px 20px 0px #d41562;}
body .center .outer_two{ransform: translateX(-238px) translateY(-50%);}
body .center .outer_two__piece{transform-origin: 129px 0px;left:144px;background:#d41562;background:#d41562;box-shadow: 0px 0px 20px 0px #d41562;height:2px;}
body .center .outer_three__piece{transform-origin: 217px 6px;width: 36px;left:230px;height:3px;}
body .center .outer_five__piece{transform-origin: 173px -9px;left:227px;background:#d41562;}
body .center .outer_four__piece{transform-origin: 205px -4px;left:243px;background:#d41562;}
body .center .pieces .future_ui__piece{transform-origin: -227px 0px;}
body .center .pieces{-webkit-transform: translateX(230px) translateY(-50%);}
body .center .pieces .blank{border:1px solid rgba(255,255,255,0.1) !important}
body .center{top:70px;}
body .center .pieces .future_ui__piece:nth-of-type(1),body .center .pieces .future_ui__piece:nth-of-type(3),body .center .pieces .future_ui__piece:nth-of-type(4),body .center .pieces .future_ui__piece:nth-of-type(2),body .center .pieces .future_ui__piece:nth-of-type(5){
  width:300px;
  border-color:#d41562;
  color:#fff;

}
body .center .pieces .future_ui__piece:nth-of-type(1){transform: rotateZ(-52deg) rotateY(0deg); width:300px;}
body .center .pieces .future_ui__piece:nth-of-type(2){transform: rotateZ(-35deg) rotateY(0deg);width:330px;}
body .center .pieces .future_ui__piece:nth-of-type(3){transform: rotateZ(-17deg) rotateY(0deg);width:360px;}
body .center .pieces .future_ui__piece:nth-of-type(4){transform: rotateZ(-1deg) rotateY(0deg);width:370px;}
body .center .pieces .future_ui__piece:nth-of-type(5){transform: rotateZ(14deg) rotateY(0deg);width:380px;}
body .center .pieces .future_ui__piece:nth-of-type(6){transform: rotateZ(32deg) rotateY(0deg);width:390px;border-color: #d41562;}
body .center .pieces .future_ui__piece:nth-of-type(1).hover{transform: rotateZ(-52deg) rotateY(0deg); width:320px;
  background:#d41562;}
body .center .pieces .future_ui__piece:nth-of-type(2).hover{transform: rotateZ(-35deg) rotateY(0deg); width:350px;
  background:#d41562;}
body .center .pieces .future_ui__piece:nth-of-type(3).hover{transform: rotateZ(-17deg) rotateY(0deg); width:390px;
  background:#d41562;}
body .center .pieces .future_ui__piece:nth-of-type(4).hover{transform: rotateZ(-1deg) rotateY(0deg); width:400px;
  background:#d41562;}
body .center .pieces .future_ui__piece:nth-of-type(5).hover{transform: rotateZ(14deg) rotateY(0deg); width:410px;
  background:#d41562;}
body .center .pieces .future_ui__piece:nth-of-type(6).hover{transform: rotateZ(32deg) rotateY(0deg); width:420px;
  background:#d41562;}
body .center .pieces .line{width:233px;;background:#d41562;z-index :-22222;position:relative;transform: rotatez(9deg);top:-23px;left:-257px}
body .center .pieces .future_ui__piece:nth-of-type(1).hover .line,
body .center .pieces .future_ui__piece:nth-of-type(2).hover .line,
body .center .pieces .future_ui__piece:nth-of-type(3).hover .line,
body .center .pieces .future_ui__piece:nth-of-type(4).hover .line,
body .center .pieces .future_ui__piece:nth-of-type(5).hover .line,
body .center .pieces .future_ui__piece:nth-of-type(6).hover .line{
width:233px;;background:#d41562;z-index :-22222;position:relative;transform: rotatez(9deg);top:-23px;left:-257px
}

// body .center .pieces .future_ui__piece:nth-of-type(1):hover{
//   transform: rotateZ(-52deg) rotateY(0deg); width:300px;
//   }
// body .center .pieces .future_ui__piece:nth-of-type(2):hover{
//  transform: rotateZ(-35deg) rotateY(0deg);width:330px;}
// body .center .pieces .future_ui__piece:nth-of-type(3):hover{
//   transform: rotateZ(-17deg) rotateY(0deg);width:360px;}
// body .center .pieces .future_ui__piece:nth-of-type(4):hover{
//  transform: rotateZ(-1deg) rotateY(0deg);width:370px;}
// body .center .pieces .future_ui__piece:nth-of-type(5):hover{
//   transform: rotateZ(14deg) rotateY(0deg);width:380px;}
// body .center .pieces .future_ui__piece:nth-of-type(6):hover{
//  transform: rotateZ(32deg) rotateY(0deg);width:390px;border-color: #d41562;}
</style>
