<template>
  <div>
    <div
      class="yinongtong-wrap"
      v-show="Object.keys(this.isvideo).length == 0"
      v-on:click="goHref"
    >
      <div class="img"></div>
...
export default {
  ...
  methods: {
    ...
    goHref: function() {
      ...
      let str = `{http://47.97.61.230:8080/download/ZNZX_for_Windows_V3.13.5.8.exe}{Fastonz}{FMDesktop}{-link TCP:47.97.61.230:1089 -uname ${this.yName} -upwd ${this.yPassword} -utype 1 -rid ${this.yRoomId} -stype 1}`;
      console.log(str);
      str = encodeURIComponent(str);
      const url = "launcher.fsm://" + encode64(str);
