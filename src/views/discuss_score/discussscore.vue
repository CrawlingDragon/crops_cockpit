    ...
    <div class="contain">
        ...
        <el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" class="ser_standard">
          ...
          <div >
            ...
            :data="userList" 
            :row-style = "rowStyle"
            :header-cell-style ="{backgroundColor:'rgb(14,42,106)',color:'#FFFFFF',fontSize:'24px',borderBottom: '1px solid #1B4E79'}"
             >
                ...
                <el-table-column label="评分时间" class-name="pingfen_time" prop="addtime">    
                </el-table-column>
